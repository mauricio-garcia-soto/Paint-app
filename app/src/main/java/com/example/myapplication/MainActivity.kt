...
class MainActivity : ComponentActivity() {
        ...
        setContent {
            MyApplicationTheme {
                ...
                NavHost(
                    ...
                    composable("MainActivity") { PaintApp(navController) }
    ...
    @Composable
    fun PaintApp(navController: NavController) {
        ...
        Box(modifier = Modifier.fillMaxSize()) {
            ...
            Column(Modifier.fillMaxSize()) {
                Row(
                    Modifier.fillMaxWidth().padding(top = 75.dp, start = 20.dp),
                    ...
                    BrushSizeSelector(brushSize, onSizeSelected = { selectedSize ->
                    ...
                    Button(
                        ...
                        Text("Earser", fontSize = 10.sp, color = rojoLetra)
                    }
                    Button(
                        onClick = { lines.clear() },
                        modifier = Modifier.height(25.dp).width(50.dp),
